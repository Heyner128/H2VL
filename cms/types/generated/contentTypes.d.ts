...
export interface ApiCoordonneesCoordonnees extends Schema.SingleType {
  collectionName: 'coordonneess';
  info: {
    singularName: 'coordonnees';
    pluralName: 'coordonneess';
  ...
  attributes: {
    ...
    numero_telephone: Attribute.String;
    ville: Attribute.String;
    email: Attribute.Email;
    code_postal: Attribute.Integer &
      Attribute.SetMinMax<
        {
          min: 0;
          max: 100000;
